...
class QAbstractItemView(QAbstractScrollArea):
    ...
    def update(self) -> None: ...
    @typing.overload
    def update(self, index: QtCore.QModelIndex) -> None: ...  # type: ignore
...
class QGraphicsView(QAbstractScrollArea):
    ...
    def render(self, painter: QtGui.QPainter, target: QtCore.QRectF = ..., source: QtCore.QRect = ..., mode: QtCore.Qt.AspectRatioMode = ...) -> None: ...  # type: ignore
    @typing.overload
